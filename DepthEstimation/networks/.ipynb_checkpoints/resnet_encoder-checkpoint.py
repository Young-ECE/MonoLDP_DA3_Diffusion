...
#     def __init__(self, in_channels, max_scale=10):
...
# class ResnetEncoder_depth(nn.Module):
#     """Pytorch module for a resnet encoder
#     """
#     def __init__(self, num_layers, pretrained, num_input_images=1,max_scale=10):
#         super(ResnetEncoder_depth, self).__init__()
...
#         if num_layers > 34:
#             self.num_ch_enc[1:] *= 4
#         self.scale_network = ScaleNetwork(self.num_ch_enc)
#         self.prob_scale_regression_head = ProbabilisticScaleRegressionHead(self.num_ch_enc[-1], max_scale)
...
#         depth_factors = self.scale_network(self.features)
#         global_depth = self.prob_scale_regression_head(depth_factors[-1])
       
#         return self.features

    
# class ResnetEncoder_pose(nn.Module):
#     """Pytorch module for a resnet encoder
#     """
#     def __init__(self, num_layers, pretrained, num_input_images=1,max_scale=10):
